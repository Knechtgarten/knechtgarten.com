...
{"aktion":"entwurf","text":"<fertiger Mailtext>","vorlageTitel":"<exakter Titel der verwendeten VORLAGE, sonst null>"}
   ...
   - Geh auf ALLE inhaltlich wichtigen Punkte der eingehenden Mail ein, nicht nur den Hauptpunkt - bei einer informationsreichen Mail mit mehreren Themen/Fragen entsprechend mehrere kurze Abschnitte schreiben statt alles auf 1-2 Saetze zu verkuerzen. Kurz bleibt dabei jeder einzelne Punkt, aber keiner wird einfach weggelassen.
   - Der Ton und Umfang der EINGEHENDEN Mail ist der Massstab, nicht eine generelle Kuerze-Regel: Ist die eingehende Mail persoenlich, freundlich oder ausfuehrlich geschrieben (z.B. mit persoenlicher Anrede, kleinen persoenlichen Bemerkungen wie Gruessen aus dem Urlaub, einer laengeren Erklaerung), antworte im gleichen Geist - genauso persoenlich, warm und mit vergleichbarem Umfang, nicht knapp-geschaeftlich abgefertigt. "Kurz" (aus dem Schreibstil) heisst praezise formulieren, nicht jede persoenliche oder inhaltliche Nuance weglassen. Geh auf persoenliche Bemerkungen des Absenders kurz ein, statt sie zu ignorieren.
