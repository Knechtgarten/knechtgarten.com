...
-- Fuer kuenftige externe Tools (Gmail, Easybill usw. - eigene Etappe, noch
-- nicht gebaut): Ziel-URL, bei internen Tools (Offertentool + Platzhalter)
-- leer/ungenutzt, da deren Link fest im Code steht.
alter table modul_sichtbarkeit add column url text;
